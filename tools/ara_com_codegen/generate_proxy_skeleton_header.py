...
def generate_header(entries: List[Dict], namespace_value: str) -> str:
    ...
    lines.extend(
        [
            ...
            "  }",
            "",
            "  ~DdsProxyEventBinding() override",
            "  {",
            "    StopNotificationThread();",
            "  }",
            "",
            "  DdsProxyEventBinding(const DdsProxyEventBinding &) = delete;",
            "  DdsProxyEventBinding &operator=(const DdsProxyEventBinding &) = delete;",
            "",
            ...
            "  {",
            "    notify_stop_.store(false);",
            "    notify_thread_ = std::thread([this]() {",
            "      while (!notify_stop_.load(std::memory_order_relaxed))",
            "      {",
            "        if (subscriber_.WaitForData(std::chrono::milliseconds(100)))",
            "        {",
            "          if (!notify_stop_.load(std::memory_order_relaxed) && receive_handler_)",
            "          {",
            "            receive_handler_();",
            "          }",
            "        }",
            ...
            "  }",
            "",
            "  ~IceoryxProxyEventBinding() override",
            "  {",
            "    StopNotificationThread();",
            "  }",
            "",
            "  IceoryxProxyEventBinding(const IceoryxProxyEventBinding &) = delete;",
            "  IceoryxProxyEventBinding &operator=(const IceoryxProxyEventBinding &) = delete;",
            "",
            "  ara::core::Result<void> Subscribe(std::size_t maxSampleCount) override",
            "  {",
            "    max_sample_count_ = std::max<std::size_t>(1U, maxSampleCount);",
            ...
            "{",
            "private:",
            "  // Commercial AUTOSAR stacks generate backend-binding glue inside",
            "  // each proxy/skeleton class. Keep the same structure here.",
            "  static std::unique_ptr<ara::com::internal::SkeletonEventBinding> CreateEventBinding(",
            "      const TopicBinding &binding)",
            "  {",
            "    const auto transport = detail::ResolveTransportBindingFromManifest();",
            "",
            ...
            "          detail::ToEventBindingConfig(binding));",
            "      if (!someip_binding)",
            "      {",
            ...
            "          new detail::DdsSkeletonEventBinding<SampleType>(detail::ResolveDdsTopicName(binding), 0U));",
            "    }",
            "",
            "    if (transport == ara::com::internal::TransportBinding::kIceoryx)",
            "    {",
            "      return std::unique_ptr<ara::com::internal::SkeletonEventBinding>(",
            "          new detail::IceoryxSkeletonEventBinding<SampleType>(binding));",
            "    }",
            "",
            ...
            "        Event(CreateEventBinding(binding))",
            "  {",
            "  }",
            "",
            ...
            "  // Commercial AUTOSAR stacks generate backend-binding glue inside",
            "  // each proxy/skeleton class. Keep the same structure here.",
            "  static std::unique_ptr<ara::com::internal::ProxyEventBinding> CreateEventBinding(",
            "      const TopicBinding &binding,",
            "      const ara::com::ServiceHandleType &handle)",
            "  {",
            "    const auto transport = detail::ResolveTransportBindingFromManifest();",
            "",
            "    if (transport == ara::com::internal::TransportBinding::kVsomeip)",
            ...
            "          new detail::DdsProxyEventBinding<SampleType>(detail::ResolveDdsTopicName(binding), 0U));",
            "    }",
            "",
            "    if (transport == ara::com::internal::TransportBinding::kIceoryx)",
            "    {",
            "      return std::unique_ptr<ara::com::internal::ProxyEventBinding>(",
            "          new detail::IceoryxProxyEventBinding<SampleType>(binding));",
            "    }",
            "",
            ...
            "        Event(CreateEventBinding(binding, handle))",
            "  {",
            "  }",
            "",
