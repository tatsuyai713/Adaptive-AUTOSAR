...
raspi_ecu,12345,,0,AdaptiveAutosar/UserApps/raspi_ecu,5,60000,/opt/autosar_ap/user_apps_build/src/apps/basic/autosar_user_raspi_ecu
my_sensor_app,12346,/run/autosar/user_apps/my_sensor_app.heartbeat,5000,AdaptiveAutosar/UserApps/my_sensor_app,5,60000,/opt/autosar_ap/user_apps_build/src/apps/feature/ecu/sensor_fusion_app
```
...
# バイナリの実行権限確認
ls -la /opt/autosar_ap/user_apps_build/src/apps/basic/autosar_user_raspi_ecu
chmod +x /opt/autosar_ap/user_apps_build/src/apps/basic/autosar_user_raspi_ecu
```
...
|------|---------------|---------|
| バイナリ | `/opt/autosar_ap/bin/` | `/autosar/bin/` |
| ライブラリ | `/opt/autosar_ap/lib/` | `/autosar/lib/` |
...
| 変数 | 説明 | デフォルト値 |
|------|------|------------|
| `AUTOSAR_AP_PREFIX` | AUTOSAR AP インストール先 | `/opt/autosar_ap` |
