...
# QNX SDP 8.0 cross-compilation toolchain for middleware libraries.
# This file follows the qcc/q++ cross style used in QNX scripts.
#
# Usage:
#   cmake -S . -B build-qnx \
#     -DCMAKE_TOOLCHAIN_FILE=scripts/cmake/qnx_toolchain.cmake \
#     -DQNX_ARCH=aarch64le
...
set(CMAKE_EXE_LINKER_FLAGS_INIT "-V${QNX_QCC_VARIANT} -lsocket")
set(CMAKE_SHARED_LINKER_FLAGS_INIT "-V${QNX_QCC_VARIANT} -lsocket")
set(CMAKE_MODULE_LINKER_FLAGS_INIT "-V${QNX_QCC_VARIANT} -lsocket")
...
# On QNX 8.0, pthread functions are provided by libc — there is no separate
# libpthread. Suppress CMake's FindThreads from adding -lpthread by telling it
# pthreads are already available.
