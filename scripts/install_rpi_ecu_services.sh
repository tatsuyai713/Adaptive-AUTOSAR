...
NM_ENV_OUTPUT="/etc/default/autosar-network-manager"
NM_WRAPPER_OUTPUT="/usr/local/bin/autosar-network-manager-wrapper.sh"

UCM_ENV_OUTPUT="/etc/default/autosar-ucm"
UCM_WRAPPER_OUTPUT="/usr/local/bin/autosar-ucm-wrapper.sh"
...
required_templates=(
  ...
  "${NM_WRAPPER_TEMPLATE}"
  "${UCM_WRAPPER_TEMPLATE}"
  "${DLT_WRAPPER_TEMPLATE}"
  "${ENV_TEMPLATE}"
...
mkdir -p "$(dirname "${NM_WRAPPER_OUTPUT}")"
mkdir -p "$(dirname "${NM_ENV_OUTPUT}")"
mkdir -p "$(dirname "${UCM_WRAPPER_OUTPUT}")"
