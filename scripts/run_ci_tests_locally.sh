...
if [[ "${SKIP_INSTALL}" == "false" ]]; then
    ...
    INSTALL_PREFIX="/tmp/autosar-ap_local_$$"
...
[[ "${SKIP_INSTALL}" == "false" ]] && echo "  - Install directory: /tmp/autosar-ap_local_*/"
echo ""
print_info "To clean up temporary files, run:"
echo "  rm -rf /tmp/ci_tests_local_* /tmp/autosar-ap_local_*"
echo ""
