...
#   ./qnx/build_all_qnx.sh [target] [action] [arch]
#
# Examples:
#   ./qnx/build_all_qnx.sh all                     # Build & install all for aarch64le
#   ./qnx/build_all_qnx.sh boost install            # Build & install Boost
#   ./qnx/build_all_qnx.sh cyclonedds build x86_64  # Build CycloneDDS for x86_64
#   ./qnx/build_all_qnx.sh all clean                # Clean all build artifacts
